...
def generate_coastal_relief_cpt(gmin, gmax, output_file="tmp.cpt"):
    ...
    trs = [
        -6000, -4000, -2500, -1500, -750, -25, -10, -5, 0,
        1, 2.5, 5, 10, 25, 50, 100, 250, 500, 1000
    ]

    colors = [
        [18, 32, 89], [28, 55, 125], [38, 84, 158], [48, 115, 184],
        [68, 150, 199], [106, 185, 209], [145, 210, 217], [181, 225, 219],
        [214, 235, 214], [211, 229, 176], [180, 214, 143], [145, 190, 112],
        [111, 162, 88], [130, 137, 82], [157, 126, 83], [181, 143, 103],
        [199, 174, 137], [218, 205, 177], [242, 239, 230]
    ]
